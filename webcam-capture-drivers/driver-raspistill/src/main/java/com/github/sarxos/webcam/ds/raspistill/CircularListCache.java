...
/**
 * ClassName: CircularListCache , cache bases on circular list, it is array implementation, FIFO <br/>
 * <font color="red">
 * Please be noted, remove is extremely low inefficient. Typical usage of this API is creating one
 * fixed length cache, and keep adding element, and then cache will auto remove oldest one.
 * </font>
 * date: Jan 23, 2019 9:00:03 AM <br/> 
 * 
