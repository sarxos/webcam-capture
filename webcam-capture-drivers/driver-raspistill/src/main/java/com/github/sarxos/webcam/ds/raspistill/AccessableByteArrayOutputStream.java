...
/**
 * added getBytes. the purpose of this class is get buf directly by getBytes method rather than toByteArray method causing Arrays.copy again.
 * 
...
public class AccessableByteArrayOutputStream extends ByteArrayOutputStream {
	...
	/**
	 * access buf array directly, I DO NOT want to copy memory again and again.
