...
public class OptionsPanel extends JPanel {
	...
	public OptionsPanel() {
		...
		awbcomboBox.setModel(new DefaultComboBoxModel(new String[] {"off", "auto", "sun", "cloud", "shade", "tungsten", "fluorescent", "incandescent", "flash", "horizon"}));
		...
		imxfxCB.setModel(new DefaultComboBoxModel(new String[] {"none", "negative", "solarise", "sketch", "denoise", "emboss", "oilpaint", "hatch", "gpen", "pastel", "watercolour", "film", "blur", "saturation", "colourswap", "washedout", "posterise", "colourpoint", "colourbalance", "cartoon"}));
