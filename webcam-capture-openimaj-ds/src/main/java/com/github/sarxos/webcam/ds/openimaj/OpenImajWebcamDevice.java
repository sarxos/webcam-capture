...
public class OpenImajWebcamDevice implements WebcamDevice {

	private static final Logger LOG = LoggerFactory.getLogger(OpenImajDataSource.class);
	...
	public OpenImajWebcamDevice(Device device) {
		this.device = device;
	}
