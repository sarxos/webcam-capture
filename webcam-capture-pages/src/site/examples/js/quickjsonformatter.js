...
window.TAB = SINGLE_TAB;

(function(global) {

	global.JSON = JSON || { };

	global.JSON.prettyFormat = function(name, object) {
		try {
			return '<pre class="CodeContainer">' + name + ' = ' + ProcessObject(object, 0, false, false, false) + '</pre>';
		} catch (e) {
			return "JSON is not well formated: " + e.message;
		}
	};
