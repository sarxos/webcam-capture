        ...
        if (open.get()) {
            ...
            try {
                ...
                if (Thread.interrupted()) {
                    ...
                    LOG.debug("Interrupted exception but thread is ok. Probably null return from queue. Close device anyway.");
//                    if (task.getDevice() != null) {
//                        if (task.getDevice().isOpen()) {
//                            task.getDevice().close();
//                        } else {
//                            LOG.debug("device was not open");
//                        }
//                    }
                }
            } catch (WebcamException e) {
